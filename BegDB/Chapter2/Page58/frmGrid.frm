...
Begin VB.Form frmGrid 
   ...
   Begin MSAdodcLib.Adodc datPrimaryRS 
      ...
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "select [Company Name],Address,City,State,Comments,Fax,Name,PubID,Telephone,Zip from Publishers Order by [Company Name]"
      Caption         =   " "
